...
:: Android packaging
set AND_CERT_NAME="Red5 Tester Tool"
set AND_CERT_PASS=123456
set AND_CERT_FILE=./certificate.p12
...
set IOS_PROVISION=cert\Red5TesterTool.mobileprovision
